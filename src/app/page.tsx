...
export default function Home() {
  ...
  const handleSignIn = (userData: User) => {
    ...
    localStorage.setItem("valtIntellodocUser", JSON.stringify(userData));
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case "chat":
        return <ChatInterface onViewDocument={setSelectedDocument} />;
      case "documents":
        return <DocumentViewer selectedDocument={selectedDocument} />;
      case "search":
        return <AdvancedSearch onViewDocument={setSelectedDocument} />;
      case "rbac":
        return <RBACMatrix />;
      case "audit":
        return <AuditLogs />;
      ...
      case "settings":
        return <Settings />;
      case "profile":
        return <Profile user={user!} onSignOut={handleSignOut} />;
      default:
        return <Homepage onGetStarted={handleGetStarted} />;
    }
  };
